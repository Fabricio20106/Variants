...
import melonystudios.variants.loot.function.*;
...
public class VSLootFunctions {
    ...
    public static final LootFunctionType SET_TEXTURE_IDENTIFIER = register("set_texture_identifier", new SetTextureIdentifier.Serializer());
