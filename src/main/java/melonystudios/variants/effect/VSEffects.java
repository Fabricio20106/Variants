...
import melonystudios.variants.effect.custom.*;
...
public class VSEffects {
    ...
    public static final RegistryObject<Effect> EXPLOSIVE_BLEND_POISONING = EFFECTS.register("explosive_blend_poisoning", ExplosiveBlendPoisoningEffect::new);
