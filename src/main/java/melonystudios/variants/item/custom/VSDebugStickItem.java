...
public class VSDebugStickItem extends FlammableItem {
    public VSDebugStickItem(Properties properties) {
        this(0, properties);
    }

    public VSDebugStickItem(int burnTime, Properties properties) {
