...
public class VSConfigEntries {
    ...
    public static final BooleanOption PAINTINGWOOD_FOREST = new BooleanOption("config.variants.paintingwood_forest", new TranslationTextComponent("config.variants.paintingwood_forest.desc"), settings -> CONFIG.paintingwoodForest, (settings, newValue) -> CONFIG.paintingwoodForest = newValue);
    public static final BooleanOption AZURE_FIELDS = new BooleanOption("config.variants.azure_fields", new TranslationTextComponent("config.variants.azure_fields.desc"), settings -> CONFIG.azureFields, (settings, newValue) -> CONFIG.azureFields = newValue);
    ...
    public static final BooleanOption GENERATE_NETHER_COAL_ORE = new BooleanOption("config.variants.nether_coal_ore", new TranslationTextComponent("config.variants.nether_coal_ore.desc"), settings -> CONFIG.netherCoalOre, (settings, newValue) -> CONFIG.netherCoalOre = newValue);
    public static final BooleanOption GENERATE_CRYSTALLIZED_MAGMA_CREAM_ORE = new BooleanOption("config.variants.crystallized_magma_cream_ore", new TranslationTextComponent("config.variants.crystallized_magma_cream_ore.desc"), settings -> CONFIG.crystallizedMagmaCreamOre, (settings, newValue) -> CONFIG.crystallizedMagmaCreamOre = newValue);
