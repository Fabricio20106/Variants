...
public class VSBlockStateProvider extends VSBlockStateModels {
    ...
    protected void registerStatesAndModels() {
        ...
        axisBlock((RotatedPillarBlock) VSBlocks.ENDERWOOD_STEM.get(), modLoc("block/enderwood_stem"), modLoc("block/enderwood_stem_top"));
        axisBlock((RotatedPillarBlock) VSBlocks.ENDERWOOD_HYPHAE.get(), modLoc("block/enderwood_stem"), modLoc("block/enderwood_stem"));
        axisBlock((RotatedPillarBlock) VSBlocks.STRIPPED_ENDERWOOD_STEM.get(), modLoc("block/stripped_enderwood_stem"), modLoc("block/stripped_enderwood_stem_top"));
        axisBlock((RotatedPillarBlock) VSBlocks.STRIPPED_ENDERWOOD_HYPHAE.get(), modLoc("block/stripped_enderwood_stem"), modLoc("block/stripped_enderwood_stem"));
        simpleBlock(VSBlocks.ENDER_WART_BLOCK.get());
        simpleBlock(VSBlocks.ENDERWOOD_PLANKS.get());
        ...
        doorBlock((DoorBlock) VSBlocks.ENDERWOOD_DOOR.get(), modLoc("block/enderwood_door_bottom"), modLoc("block/enderwood_door_top"));
        trapdoorBlock((TrapDoorBlock) VSBlocks.ENDERWOOD_TRAPDOOR.get(), modLoc("block/enderwood_trapdoor"), true);
        simpleBlock(VSBlocks.ENDERWOOD_SIGN.get(), models().getBuilder("enderwood_sign").texture("particle", modLoc("block/enderwood_planks")));
        simpleBlock(VSBlocks.ENDERWOOD_WALL_SIGN.get(), models().getBuilder("enderwood_wall_sign").texture("particle", modLoc("block/enderwood_planks")));
        ...
        simpleBlock(VSBlocks.END_SPROUTS.get(), models().cross("end_sprouts", modLoc("block/end_sprouts")));
