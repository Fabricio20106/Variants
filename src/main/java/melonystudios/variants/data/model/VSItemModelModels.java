...
public abstract class VSItemModelModels extends ItemModelProvider {
    ...
    public void fullStainedGlassBottle(String name, ResourceLocation bottleContents) {
        ...
        getBuilder(name).parent(this.generated).texture("layer0", modLoc("item/bottle/white_stained_glass_bottle"))
                .override().predicate(textureID(), 0).model(getExistingFile(modLoc("item/bottle/white_" + name))).end()
                .override().predicate(textureID(), 1).model(getExistingFile(modLoc("item/bottle/light_gray_" + name))).end()
                .override().predicate(textureID(), 2).model(getExistingFile(modLoc("item/bottle/gray_" + name))).end()
                .override().predicate(textureID(), 3).model(getExistingFile(modLoc("item/bottle/black_" + name))).end()
                .override().predicate(textureID(), 4).model(getExistingFile(modLoc("item/bottle/brown_" + name))).end()
                .override().predicate(textureID(), 5).model(getExistingFile(modLoc("item/bottle/red_" + name))).end()
                .override().predicate(textureID(), 6).model(getExistingFile(modLoc("item/bottle/orange_" + name))).end()
                .override().predicate(textureID(), 7).model(getExistingFile(modLoc("item/bottle/yellow_" + name))).end()
                .override().predicate(textureID(), 8).model(getExistingFile(modLoc("item/bottle/lime_" + name))).end()
                .override().predicate(textureID(), 9).model(getExistingFile(modLoc("item/bottle/green_" + name))).end()
                .override().predicate(textureID(), 10).model(getExistingFile(modLoc("item/bottle/cyan_" + name))).end()
                .override().predicate(textureID(), 11).model(getExistingFile(modLoc("item/bottle/light_blue_" + name))).end()
                .override().predicate(textureID(), 12).model(getExistingFile(modLoc("item/bottle/blue_" + name))).end()
                .override().predicate(textureID(), 13).model(getExistingFile(modLoc("item/bottle/purple_" + name))).end()
                .override().predicate(textureID(), 14).model(getExistingFile(modLoc("item/bottle/magenta_" + name))).end()
                .override().predicate(textureID(), 15).model(getExistingFile(modLoc("item/bottle/pink_" + name))).end()
                .override().predicate(textureID(), 16).model(getExistingFile(modLoc("item/bottle/glow_black_" + name))).end()
                .override().predicate(textureID(), 17).model(getExistingFile(modLoc("item/bottle/quartz_" + name))).end();
    }
}
