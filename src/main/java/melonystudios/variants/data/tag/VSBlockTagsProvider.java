...
public class VSBlockTagsProvider extends BlockTagsProvider {
    ...
    protected void addTags() {
        ...
        this.tag(VSBlockTags.GLASS_GLOW_BLACK).add(VSBlocks.GLOW_BLACK_STAINED_GLASS.get());
        this.tag(VSBlockTags.GLASS_PANES_GLOW_BLACK).add(VSBlocks.GLOW_BLACK_STAINED_GLASS_PANE.get());
        ...
        this.tag(VSBlockTags.BOOKSHELVES).add(Blocks.BOOKSHELF).add(VSBlocks.ENDERWOOD_BOOKSHELF.get()).add(VSBlocks.PLAIN_BIRCH_BOOKSHELF.get());
        this.tag(VSBlockTags.PAINTING_LOGS).add(VSBlocks.PAINTING_LOG.get()).add(VSBlocks.PAINTING_WOOD.get()).add(VSBlocks.STRIPPED_PAINTING_LOG.get()).add(VSBlocks.STRIPPED_PAINTING_WOOD.get());
        this.tag(VSBlockTags.ENDERWOOD_STEMS).add(VSBlocks.ENDERWOOD_STEM.get()).add(VSBlocks.ENDERWOOD_HYPHAE.get()).add(VSBlocks.STRIPPED_ENDERWOOD_STEM.get()).add(VSBlocks.STRIPPED_ENDERWOOD_HYPHAE.get());
        this.tag(VSBlockTags.CAULDRONS).add(Blocks.CAULDRON).add(VSBlocks.GOLDEN_CAULDRON.get()).add(VSBlocks.QUARTZ_CAULDRON.get());
        this.tag(VSBlockTags.BEACONS).add(Blocks.BEACON).add(VSBlocks.GOLDEN_BEACON.get()).add(VSBlocks.QUARTZ_BEACON.get());
