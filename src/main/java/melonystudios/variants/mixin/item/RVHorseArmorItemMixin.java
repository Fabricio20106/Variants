...
public class RVHorseArmorItemMixin extends Item {
    public RVHorseArmorItemMixin(Properties properties) {
        super(properties);
    }
    ...
    public void appendHoverText(ItemStack stack, @Nullable World world, List<ITextComponent> tooltip, ITooltipFlag flag) {
        ...
        if (Variants.revaried().settings().horseArmorPointsTooltip && NBTUtils.shouldNotHideTooltip("hide_horse_armor_armor_points", stack)) {
