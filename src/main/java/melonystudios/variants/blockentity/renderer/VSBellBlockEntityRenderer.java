...
public class VSBellBlockEntityRenderer extends TileEntityRenderer<VSBellBlockEntity> {
    ...
    @Override
    public void render(VSBellBlockEntity bell, float partialTicks, MatrixStack stack, IRenderTypeBuffer buffer, int combinedLight, int combinedOverlay) {
        ...
        this.bellBody.render(stack, vertexBuilder, combinedLight, combinedOverlay);
    }
}
