...
import melonystudios.variants.blockentity.container.VSBeaconContainer;
...
public class VSBeaconBlockEntity extends BeaconTileEntity {
        ...
        public void set(int currentLevel, int newLevel) {
            switch (currentLevel) {
                case 0:
                    ...
                    break;
                case 1:
                    assert VSBeaconBlockEntity.this.level != null;
    ...
    public AxisAlignedBB getRenderBoundingBox() {
        ...
        if (getBlockState().is(VSBlockTags.BEACONS)) {
