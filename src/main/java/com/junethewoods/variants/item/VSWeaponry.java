...
public class VSWeaponry {
    ...
    public static final RegistryObject<Item> INFINITY_SWEATERS_TAB_ICON = ITEMS.register("infinity_sweaters_tab_icon", () -> new Item(new Item.Properties().stacksTo(1).fireResistant().rarity(Rarity.EPIC)));
