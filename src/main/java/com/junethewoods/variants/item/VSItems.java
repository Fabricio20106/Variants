...
import com.junethewoods.variants.item.custom.dispenser.*;
...
public class VSItems {
    ...
    public static final RegistryObject<Item> LAVA_BOTTLE = ITEMS.register("lava_glass_bottle", () -> new LavaBottleItem(false, new Item.Properties().stacksTo(8).craftRemainder(Items.GLASS_BOTTLE).tab(VSTab.TAB)));
    public static final RegistryObject<Item> SOUL_LAVA_BOTTLE = ITEMS.register("soul_lava_bottle", () -> new LavaBottleItem(true, new Item.Properties().stacksTo(8).craftRemainder(Items.GLASS_BOTTLE).tab(VSTab.TAB)));
    ...
    public static final RegistryObject<Item> REDSTONE_POT = ITEMS.register("redstone_pot", () -> new StylisedPotItem(new Item.Properties().stacksTo(16).tab(VSTab.TAB), new RedstonePoisoningType(), 10));
    public static final RegistryObject<Item> BLUESTONE_POT = ITEMS.register("bluestone_pot", () -> new StylisedPotItem(new Item.Properties().stacksTo(16).tab(VSTab.TAB), "Fabricio2010's Pack", new BluestonePoisoningType(), 10));
    public static final RegistryObject<Item> GLOWSTONE_POT = ITEMS.register("glowstone_pot", () -> new StylisedPotItem(new Item.Properties().stacksTo(16).tab(VSTab.TAB), new GlowstonePoisoningType(), 10));
    public static final RegistryObject<Item> GUNPOWDER_POT = ITEMS.register("gunpowder_pot", () -> new StylisedPotItem(new Item.Properties().stacksTo(16).tab(VSTab.TAB), new GunpowderPoisoningType(), 10));
    public static final RegistryObject<Item> EXPLOSIVE_BLEND_POT = ITEMS.register("creeper_powder_pot", () -> new StylisedPotItem(new Item.Properties().stacksTo(16).tab(VSTab.TAB), "Creeper Edits", new ExplosiveBlendPoisoningType(), 10));
    ...
    public static final RegistryObject<Item> EXPONENTIAL_SUSPICIOUS_STEW = ITEMS.register("exponential_suspicious_stew", () -> new ExponentialStewItem(new DefaultStewBehavior(), new Item.Properties().stacksTo(1).food(Foods.SUSPICIOUS_STEW).tab(VSTab.TAB)));
    ...
    public static final RegistryObject<Item> EXPONENTIAL_WATER_BOWL = ITEMS.register("exponential_water_bowl", () -> new ExponentialStewItem(new EffectStewBehavior(new EffectInstance(Effects.WATER_BREATHING, 100)), new Item.Properties().stacksTo(1).food(VSFoods.FLUID_BOWL).tab(VSTab.TAB)));
    public static final RegistryObject<Item> EXPONENTIAL_MILK_BOWL = ITEMS.register("exponential_milk_bowl", () -> new ExponentialStewItem(new MilkStewBehavior(), new Item.Properties().stacksTo(1).food(VSFoods.MILK_BOWL).tab(VSTab.TAB)));
    public static final RegistryObject<Item> EXPONENTIAL_LAVA_BOWL = ITEMS.register("exponential_lava_bowl", () -> new ExponentialStewItem(new LavaStewBehavior(false), new Item.Properties().stacksTo(1).food(VSFoods.FLUID_BOWL).tab(VSTab.TAB)));
    public static final RegistryObject<Item> EXPONENTIAL_SOUL_LAVA_BOWL = ITEMS.register("exponential_soul_lava_bowl", () -> new ExponentialStewItem(new LavaStewBehavior(true), new Item.Properties().stacksTo(1).food(Foods.MUSHROOM_STEW).tab(VSTab.TAB)));
