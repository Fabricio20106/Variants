...
public class VSStewBehaviors {
    ...
    public static final RegistryObject<StewBehavior> MILK = BEHAVIORS.register("milk", ClearMobEffectsBehavior::new);
    public static final RegistryObject<StewBehavior> LAVA = BEHAVIORS.register("lava", SetOnFireBehavior::new);
    public static final RegistryObject<StewBehavior> EFFECT = BEHAVIORS.register("effect", ApplyMobEffectsBehavior::new);
}
