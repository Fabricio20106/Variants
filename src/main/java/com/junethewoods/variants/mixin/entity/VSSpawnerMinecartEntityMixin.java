...
public abstract class VSSpawnerMinecartEntityMixin extends Entity {
    ...
    public void destroy(DamageSource source) {
        this.remove();
        if (VSConfigs.COMMON_CONFIGS.placeSpawnerWhenBreakingMinecart.get() && !this.level.getBlockState(this.blockPosition()).is(VSTags.Blocks.SPAWNER_MINECART_CANNOT_REPLACE) && this.level.getGameRules().getBoolean(GameRules.RULE_DOENTITYDROPS)) {
