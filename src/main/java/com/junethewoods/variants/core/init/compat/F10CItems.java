...
import com.junethewoods.variants.core.tab.VSBlocksTab;
import com.junethewoods.variants.core.tab.VSTab;
...
public class F10CItems {
    ...
    // Edits
    // Purple (Iron) Nuggets are already in Edits.
    public static final RegistryObject<Item> SPLASH_SOPH_POTION = ITEMS_EDITS.register("splash_soph_potion", () -> new Item(new Item.Properties().food(F10CFoods.SPLASH_SOPH_POTION).tab(VSTab.TAB)));
    ...
    // Fabricio2010's Pack
    public static final RegistryObject<Item> FIRST_DOOR = ITEMS_F10PACK.register("first_door", () -> new BlockItem(F10CBlocks.FIRST_DOOR.get(), new Item.Properties().tab(VSBlocksTab.TAB)));
    public static final RegistryObject<Item> PLAIN_BIRCH_BOOKSHELF = ITEMS_F10PACK.register("plain_birch_bookshelf", () -> new BlockItem(F10CBlocks.PLAIN_BIRCH_BOOKSHELF.get(), new Item.Properties().tab(VSBlocksTab.TAB)));
    ...
    // Back Math
    // This is not in the Variants 1.16 branch because Back Math added it itself.
