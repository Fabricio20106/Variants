...
import com.junethewoods.variants.core.tab.VSFoodstuffsTab;
...
public class VSItems {
    ...
    public static final RegistryObject<Item> SPRUCE_CRAFTING_TABLE = ITEMS.register("spruce_crafting_table", () -> new BlockItem(VSBlocks.SPRUCE_CRAFTING_TABLE.get(), new Item.Properties().tab(VSBlocksTab.TAB)));
    public static final RegistryObject<Item> BIRCH_CRAFTING_TABLE = ITEMS.register("birch_crafting_table", () -> new BlockItem(VSBlocks.BIRCH_CRAFTING_TABLE.get(), new Item.Properties().tab(VSBlocksTab.TAB)));
    public static final RegistryObject<Item> JUNGLE_CRAFTING_TABLE = ITEMS.register("jungle_crafting_table", () -> new BlockItem(VSBlocks.JUNGLE_CRAFTING_TABLE.get(), new Item.Properties().tab(VSBlocksTab.TAB)));
    public static final RegistryObject<Item> ACACIA_CRAFTING_TABLE = ITEMS.register("acacia_crafting_table", () -> new BlockItem(VSBlocks.ACACIA_CRAFTING_TABLE.get(), new Item.Properties().tab(VSBlocksTab.TAB)));
    public static final RegistryObject<Item> DARK_OAK_CRAFTING_TABLE = ITEMS.register("dark_oak_crafting_table", () -> new BlockItem(VSBlocks.DARK_OAK_CRAFTING_TABLE.get(), new Item.Properties().tab(VSBlocksTab.TAB)));
    public static final RegistryObject<Item> PAINTING_CRAFTING_TABLE = ITEMS.register("painting_crafting_table", () -> new BlockItem(VSBlocks.PAINTING_CRAFTING_TABLE.get(), new Item.Properties().tab(VSBlocksTab.TAB)));
    public static final RegistryObject<Item> CRIMSON_CRAFTING_TABLE = ITEMS.register("crimson_crafting_table", () -> new BlockItem(VSBlocks.CRIMSON_CRAFTING_TABLE.get(), new Item.Properties().tab(VSBlocksTab.TAB)));
    public static final RegistryObject<Item> WARPED_CRAFTING_TABLE = ITEMS.register("warped_crafting_table", () -> new BlockItem(VSBlocks.WARPED_CRAFTING_TABLE.get(), new Item.Properties().tab(VSBlocksTab.TAB)));
    public static final RegistryObject<Item> ENDER_CRAFTING_TABLE = ITEMS.register("ender_crafting_table", () -> new BlockItem(VSBlocks.ENDER_CRAFTING_TABLE.get(), new Item.Properties().tab(VSBlocksTab.TAB)));
    ...
    public static final RegistryObject<Item> GLOWSTONE_POT = ITEMS.register("glowstone_pot", () -> new Item(new Item.Properties().stacksTo(1).food(VSFoods.GLOWSTONE_POT).tab(VSTab.TAB)));
    ...
    // Foodstuffs
    public static final RegistryObject<Item> oak_fungi_stew = ITEMS.register("oak_fungi_stew", () -> new CustomSoupItem.OakBowl(new Item.Properties().stacksTo(1).tab(VSFoodstuffsTab.TAB).food(Foods.MUSHROOM_STEW)));
    public static final RegistryObject<Item> spruce_fungi_stew = ITEMS.register("spruce_fungi_stew", () -> new CustomSoupItem.SpruceBowl(new Item.Properties().stacksTo(1).tab(VSFoodstuffsTab.TAB).food(Foods.MUSHROOM_STEW)));
    public static final RegistryObject<Item> birch_fungi_stew = ITEMS.register("birch_fungi_stew", () -> new CustomSoupItem.BirchBowl(new Item.Properties().stacksTo(1).tab(VSFoodstuffsTab.TAB).food(Foods.MUSHROOM_STEW)));
    public static final RegistryObject<Item> jungle_fungi_stew = ITEMS.register("jungle_fungi_stew", () -> new CustomSoupItem.JungleBowl(new Item.Properties().stacksTo(1).tab(VSFoodstuffsTab.TAB).food(Foods.MUSHROOM_STEW)));
    public static final RegistryObject<Item> acacia_fungi_stew = ITEMS.register("acacia_fungi_stew", () -> new CustomSoupItem.AcaciaBowl(new Item.Properties().stacksTo(1).tab(VSFoodstuffsTab.TAB).food(Foods.MUSHROOM_STEW)));
    public static final RegistryObject<Item> dark_oak_fungi_stew = ITEMS.register("dark_oak_fungi_stew", () -> new CustomSoupItem.DarkOakBowl(new Item.Properties().stacksTo(1).tab(VSFoodstuffsTab.TAB).food(Foods.MUSHROOM_STEW)));
    public static final RegistryObject<Item> painting_fungi_stew = ITEMS.register("painting_fungi_stew", () -> new CustomSoupItem.PaintingBowl(new Item.Properties().stacksTo(1).tab(VSFoodstuffsTab.TAB).food(Foods.MUSHROOM_STEW)));
    public static final RegistryObject<Item> crimson_fungi_stew = ITEMS.register("crimson_fungi_stew", () -> new CustomSoupItem.CrimsonBowl(new Item.Properties().stacksTo(1).tab(VSFoodstuffsTab.TAB).food(Foods.MUSHROOM_STEW)));
    public static final RegistryObject<Item> warped_fungi_stew = ITEMS.register("warped_fungi_stew", () -> new CustomSoupItem.WarpedBowl(new Item.Properties().stacksTo(1).tab(VSFoodstuffsTab.TAB).food(Foods.MUSHROOM_STEW)));
    public static final RegistryObject<Item> ender_fungi_stew = ITEMS.register("ender_fungi_stew", () -> new CustomSoupItem.EnderBowl(new Item.Properties().stacksTo(1).tab(VSFoodstuffsTab.TAB).food(Foods.MUSHROOM_STEW)));
    public static final RegistryObject<Item> oak_end_fungi_stew = ITEMS.register("oak_end_fungi_stew", () -> new CustomSoupItem.OakBowl(new Item.Properties().stacksTo(1).tab(VSFoodstuffsTab.TAB).food(Foods.MUSHROOM_STEW)));
    public static final RegistryObject<Item> spruce_end_fungi_stew = ITEMS.register("spruce_end_fungi_stew", () -> new CustomSoupItem.SpruceBowl(new Item.Properties().stacksTo(1).tab(VSFoodstuffsTab.TAB).food(Foods.MUSHROOM_STEW)));
    public static final RegistryObject<Item> birch_end_fungi_stew = ITEMS.register("birch_end_fungi_stew", () -> new CustomSoupItem.BirchBowl(new Item.Properties().stacksTo(1).tab(VSFoodstuffsTab.TAB).food(Foods.MUSHROOM_STEW)));
    public static final RegistryObject<Item> jungle_end_fungi_stew = ITEMS.register("jungle_end_fungi_stew", () -> new CustomSoupItem.JungleBowl(new Item.Properties().stacksTo(1).tab(VSFoodstuffsTab.TAB).food(Foods.MUSHROOM_STEW)));
    public static final RegistryObject<Item> acacia_end_fungi_stew = ITEMS.register("acacia_end_fungi_stew", () -> new CustomSoupItem.AcaciaBowl(new Item.Properties().stacksTo(1).tab(VSFoodstuffsTab.TAB).food(Foods.MUSHROOM_STEW)));
    public static final RegistryObject<Item> dark_oak_end_fungi_stew = ITEMS.register("dark_oak_end_fungi_stew", () -> new CustomSoupItem.DarkOakBowl(new Item.Properties().stacksTo(1).tab(VSFoodstuffsTab.TAB).food(Foods.MUSHROOM_STEW)));
    public static final RegistryObject<Item> painting_end_fungi_stew = ITEMS.register("painting_end_fungi_stew", () -> new CustomSoupItem.PaintingBowl(new Item.Properties().stacksTo(1).tab(VSFoodstuffsTab.TAB).food(Foods.MUSHROOM_STEW)));
    public static final RegistryObject<Item> crimson_end_fungi_stew = ITEMS.register("crimson_end_fungi_stew", () -> new CustomSoupItem.CrimsonBowl(new Item.Properties().stacksTo(1).tab(VSFoodstuffsTab.TAB).food(Foods.MUSHROOM_STEW)));
    public static final RegistryObject<Item> warped_end_fungi_stew = ITEMS.register("warped_end_fungi_stew", () -> new CustomSoupItem.WarpedBowl(new Item.Properties().stacksTo(1).tab(VSFoodstuffsTab.TAB).food(Foods.MUSHROOM_STEW)));
    public static final RegistryObject<Item> ender_end_fungi_stew = ITEMS.register("ender_end_fungi_stew", () -> new CustomSoupItem.EnderBowl(new Item.Properties().stacksTo(1).tab(VSFoodstuffsTab.TAB).food(Foods.MUSHROOM_STEW)));
    public static final RegistryObject<Item> oak_mushroom_stew = ITEMS.register("oak_mushroom_stew", () -> new CustomSoupItem.OakBowl(new Item.Properties().stacksTo(1).tab(VSFoodstuffsTab.TAB).food(Foods.MUSHROOM_STEW)));
    public static final RegistryObject<Item> spruce_mushroom_stew = ITEMS.register("spruce_mushroom_stew", () -> new CustomSoupItem.SpruceBowl(new Item.Properties().stacksTo(1).tab(VSFoodstuffsTab.TAB).food(Foods.MUSHROOM_STEW)));
    public static final RegistryObject<Item> birch_mushroom_stew = ITEMS.register("birch_mushroom_stew", () -> new CustomSoupItem.BirchBowl(new Item.Properties().stacksTo(1).tab(VSFoodstuffsTab.TAB).food(Foods.MUSHROOM_STEW)));
    public static final RegistryObject<Item> jungle_mushroom_stew = ITEMS.register("jungle_mushroom_stew", () -> new CustomSoupItem.JungleBowl(new Item.Properties().stacksTo(1).tab(VSFoodstuffsTab.TAB).food(Foods.MUSHROOM_STEW)));
    public static final RegistryObject<Item> acacia_mushroom_stew = ITEMS.register("acacia_mushroom_stew", () -> new CustomSoupItem.AcaciaBowl(new Item.Properties().stacksTo(1).tab(VSFoodstuffsTab.TAB).food(Foods.MUSHROOM_STEW)));
    public static final RegistryObject<Item> dark_oak_mushroom_stew = ITEMS.register("dark_oak_mushroom_stew", () -> new CustomSoupItem.DarkOakBowl(new Item.Properties().stacksTo(1).tab(VSFoodstuffsTab.TAB).food(Foods.MUSHROOM_STEW)));
    public static final RegistryObject<Item> painting_mushroom_stew = ITEMS.register("painting_mushroom_stew", () -> new CustomSoupItem.PaintingBowl(new Item.Properties().stacksTo(1).tab(VSFoodstuffsTab.TAB).food(Foods.MUSHROOM_STEW)));
    public static final RegistryObject<Item> crimson_mushroom_stew = ITEMS.register("crimson_mushroom_stew", () -> new CustomSoupItem.CrimsonBowl(new Item.Properties().stacksTo(1).tab(VSFoodstuffsTab.TAB).food(Foods.MUSHROOM_STEW)));
    public static final RegistryObject<Item> warped_mushroom_stew = ITEMS.register("warped_mushroom_stew", () -> new CustomSoupItem.WarpedBowl(new Item.Properties().stacksTo(1).tab(VSFoodstuffsTab.TAB).food(Foods.MUSHROOM_STEW)));
    public static final RegistryObject<Item> ender_mushroom_stew = ITEMS.register("ender_mushroom_stew", () -> new CustomSoupItem.EnderBowl(new Item.Properties().stacksTo(1).tab(VSFoodstuffsTab.TAB).food(Foods.MUSHROOM_STEW)));
    public static final RegistryObject<Item> oak_suspicious_stew = ITEMS.register("oak_suspicious_stew", () -> new CustomSuspiciousSoupItem.OakBowl(new Item.Properties().stacksTo(1).tab(VSFoodstuffsTab.TAB).food(Foods.MUSHROOM_STEW)));
    public static final RegistryObject<Item> spruce_suspicious_stew = ITEMS.register("spruce_suspicious_stew", () -> new CustomSuspiciousSoupItem.SpruceBowl(new Item.Properties().stacksTo(1).tab(VSFoodstuffsTab.TAB).food(Foods.MUSHROOM_STEW)));
    public static final RegistryObject<Item> birch_suspicious_stew = ITEMS.register("birch_suspicious_stew", () -> new CustomSuspiciousSoupItem.BirchBowl(new Item.Properties().stacksTo(1).tab(VSFoodstuffsTab.TAB).food(Foods.MUSHROOM_STEW)));
    public static final RegistryObject<Item> jungle_suspicious_stew = ITEMS.register("jungle_suspicious_stew", () -> new CustomSuspiciousSoupItem.JungleBowl(new Item.Properties().stacksTo(1).tab(VSFoodstuffsTab.TAB).food(Foods.MUSHROOM_STEW)));
    public static final RegistryObject<Item> acacia_suspicious_stew = ITEMS.register("acacia_suspicious_stew", () -> new CustomSuspiciousSoupItem.AcaciaBowl(new Item.Properties().stacksTo(1).tab(VSFoodstuffsTab.TAB).food(Foods.MUSHROOM_STEW)));
    public static final RegistryObject<Item> dark_oak_suspicious_stew = ITEMS.register("dark_oak_suspicious_stew", () -> new CustomSuspiciousSoupItem.DarkOakBowl(new Item.Properties().stacksTo(1).tab(VSFoodstuffsTab.TAB).food(Foods.MUSHROOM_STEW)));
    public static final RegistryObject<Item> painting_suspicious_stew = ITEMS.register("painting_suspicious_stew", () -> new CustomSuspiciousSoupItem.PaintingBowl(new Item.Properties().stacksTo(1).tab(VSFoodstuffsTab.TAB).food(Foods.MUSHROOM_STEW)));
    public static final RegistryObject<Item> crimson_suspicious_stew = ITEMS.register("crimson_suspicious_stew", () -> new CustomSuspiciousSoupItem.CrimsonBowl(new Item.Properties().stacksTo(1).tab(VSFoodstuffsTab.TAB).food(Foods.MUSHROOM_STEW)));
    public static final RegistryObject<Item> warped_suspicious_stew = ITEMS.register("warped_suspicious_stew", () -> new CustomSuspiciousSoupItem.WarpedBowl(new Item.Properties().stacksTo(1).tab(VSFoodstuffsTab.TAB).food(Foods.MUSHROOM_STEW)));
    public static final RegistryObject<Item> ender_suspicious_stew = ITEMS.register("ender_suspicious_stew", () -> new CustomSuspiciousSoupItem.EnderBowl(new Item.Properties().stacksTo(1).tab(VSFoodstuffsTab.TAB).food(Foods.MUSHROOM_STEW)));
    public static final RegistryObject<Item> oak_rabbit_stew = ITEMS.register("oak_rabbit_stew", () -> new CustomSoupItem.OakBowl(new Item.Properties().stacksTo(1).tab(VSFoodstuffsTab.TAB).food(Foods.RABBIT_STEW)));
    public static final RegistryObject<Item> spruce_rabbit_stew = ITEMS.register("spruce_rabbit_stew", () -> new CustomSoupItem.SpruceBowl(new Item.Properties().stacksTo(1).tab(VSFoodstuffsTab.TAB).food(Foods.RABBIT_STEW)));
    public static final RegistryObject<Item> birch_rabbit_stew = ITEMS.register("birch_rabbit_stew", () -> new CustomSoupItem.BirchBowl(new Item.Properties().stacksTo(1).tab(VSFoodstuffsTab.TAB).food(Foods.RABBIT_STEW)));
    public static final RegistryObject<Item> jungle_rabbit_stew = ITEMS.register("jungle_rabbit_stew", () -> new CustomSoupItem.JungleBowl(new Item.Properties().stacksTo(1).tab(VSFoodstuffsTab.TAB).food(Foods.RABBIT_STEW)));
    public static final RegistryObject<Item> acacia_rabbit_stew = ITEMS.register("acacia_rabbit_stew", () -> new CustomSoupItem.AcaciaBowl(new Item.Properties().stacksTo(1).tab(VSFoodstuffsTab.TAB).food(Foods.RABBIT_STEW)));
    public static final RegistryObject<Item> dark_oak_rabbit_stew = ITEMS.register("dark_oak_rabbit_stew", () -> new CustomSoupItem.DarkOakBowl(new Item.Properties().stacksTo(1).tab(VSFoodstuffsTab.TAB).food(Foods.RABBIT_STEW)));
    public static final RegistryObject<Item> painting_rabbit_stew = ITEMS.register("painting_rabbit_stew", () -> new CustomSoupItem.PaintingBowl(new Item.Properties().stacksTo(1).tab(VSFoodstuffsTab.TAB).food(Foods.RABBIT_STEW)));
    public static final RegistryObject<Item> crimson_rabbit_stew = ITEMS.register("crimson_rabbit_stew", () -> new CustomSoupItem.CrimsonBowl(new Item.Properties().stacksTo(1).tab(VSFoodstuffsTab.TAB).food(Foods.RABBIT_STEW)));
    public static final RegistryObject<Item> warped_rabbit_stew = ITEMS.register("warped_rabbit_stew", () -> new CustomSoupItem.WarpedBowl(new Item.Properties().stacksTo(1).tab(VSFoodstuffsTab.TAB).food(Foods.RABBIT_STEW)));
    public static final RegistryObject<Item> ender_rabbit_stew = ITEMS.register("ender_rabbit_stew", () -> new CustomSoupItem.EnderBowl(new Item.Properties().stacksTo(1).tab(VSFoodstuffsTab.TAB).food(Foods.RABBIT_STEW)));
    public static final RegistryObject<Item> oak_beetroot_soup = ITEMS.register("oak_beetroot_soup", () -> new CustomSoupItem.OakBowl(new Item.Properties().stacksTo(1).tab(VSFoodstuffsTab.TAB).food(Foods.BEETROOT_SOUP)));
    public static final RegistryObject<Item> spruce_beetroot_soup = ITEMS.register("spruce_beetroot_soup", () -> new CustomSoupItem.SpruceBowl(new Item.Properties().stacksTo(1).tab(VSFoodstuffsTab.TAB).food(Foods.BEETROOT_SOUP)));
    public static final RegistryObject<Item> birch_beetroot_soup = ITEMS.register("birch_beetroot_soup", () -> new CustomSoupItem.BirchBowl(new Item.Properties().stacksTo(1).tab(VSFoodstuffsTab.TAB).food(Foods.BEETROOT_SOUP)));
    public static final RegistryObject<Item> jungle_beetroot_soup = ITEMS.register("jungle_beetroot_soup", () -> new CustomSoupItem.JungleBowl(new Item.Properties().stacksTo(1).tab(VSFoodstuffsTab.TAB).food(Foods.BEETROOT_SOUP)));
    public static final RegistryObject<Item> acacia_beetroot_soup = ITEMS.register("acacia_beetroot_soup", () -> new CustomSoupItem.AcaciaBowl(new Item.Properties().stacksTo(1).tab(VSFoodstuffsTab.TAB).food(Foods.BEETROOT_SOUP)));
    public static final RegistryObject<Item> dark_oak_beetroot_soup = ITEMS.register("dark_oak_beetroot_soup", () -> new CustomSoupItem.DarkOakBowl(new Item.Properties().stacksTo(1).tab(VSFoodstuffsTab.TAB).food(Foods.BEETROOT_SOUP)));
    public static final RegistryObject<Item> painting_beetroot_soup = ITEMS.register("painting_beetroot_soup", () -> new CustomSoupItem.PaintingBowl(new Item.Properties().stacksTo(1).tab(VSFoodstuffsTab.TAB).food(Foods.BEETROOT_SOUP)));
    public static final RegistryObject<Item> crimson_beetroot_soup = ITEMS.register("crimson_beetroot_soup", () -> new CustomSoupItem.CrimsonBowl(new Item.Properties().stacksTo(1).tab(VSFoodstuffsTab.TAB).food(Foods.BEETROOT_SOUP)));
    public static final RegistryObject<Item> warped_beetroot_soup = ITEMS.register("warped_beetroot_soup", () -> new CustomSoupItem.WarpedBowl(new Item.Properties().stacksTo(1).tab(VSFoodstuffsTab.TAB).food(Foods.BEETROOT_SOUP)));
    public static final RegistryObject<Item> ender_beetroot_soup = ITEMS.register("ender_beetroot_soup", () -> new CustomSoupItem.EnderBowl(new Item.Properties().stacksTo(1).tab(VSFoodstuffsTab.TAB).food(Foods.BEETROOT_SOUP)));
    public static final RegistryObject<Item> oak_water_stew = ITEMS.register("oak_water_stew", () -> new CustomSoupItem.OakBowl(new Item.Properties().stacksTo(1).tab(VSFoodstuffsTab.TAB).food(VSFoods.WATER_BOWL)));
    public static final RegistryObject<Item> spruce_water_stew = ITEMS.register("spruce_water_stew", () -> new CustomSoupItem.SpruceBowl(new Item.Properties().stacksTo(1).tab(VSFoodstuffsTab.TAB).food(VSFoods.WATER_BOWL)));
    public static final RegistryObject<Item> birch_water_stew = ITEMS.register("birch_water_stew", () -> new CustomSoupItem.BirchBowl(new Item.Properties().stacksTo(1).tab(VSFoodstuffsTab.TAB).food(VSFoods.WATER_BOWL)));
    public static final RegistryObject<Item> jungle_water_stew = ITEMS.register("jungle_water_stew", () -> new CustomSoupItem.JungleBowl(new Item.Properties().stacksTo(1).tab(VSFoodstuffsTab.TAB).food(VSFoods.WATER_BOWL)));
    public static final RegistryObject<Item> acacia_water_stew = ITEMS.register("acacia_water_stew", () -> new CustomSoupItem.AcaciaBowl(new Item.Properties().stacksTo(1).tab(VSFoodstuffsTab.TAB).food(VSFoods.WATER_BOWL)));
    public static final RegistryObject<Item> dark_oak_water_stew = ITEMS.register("dark_oak_water_stew", () -> new CustomSoupItem.DarkOakBowl(new Item.Properties().stacksTo(1).tab(VSFoodstuffsTab.TAB).food(VSFoods.WATER_BOWL)));
    public static final RegistryObject<Item> painting_water_stew = ITEMS.register("painting_water_stew", () -> new CustomSoupItem.PaintingBowl(new Item.Properties().stacksTo(1).tab(VSFoodstuffsTab.TAB).food(VSFoods.WATER_BOWL)));
    public static final RegistryObject<Item> crimson_water_stew = ITEMS.register("crimson_water_stew", () -> new CustomSoupItem.CrimsonBowl(new Item.Properties().stacksTo(1).tab(VSFoodstuffsTab.TAB).food(VSFoods.WATER_BOWL)));
    public static final RegistryObject<Item> warped_water_stew = ITEMS.register("warped_water_stew", () -> new CustomSoupItem.WarpedBowl(new Item.Properties().stacksTo(1).tab(VSFoodstuffsTab.TAB).food(VSFoods.WATER_BOWL)));
    public static final RegistryObject<Item> ender_water_stew = ITEMS.register("ender_water_stew", () -> new CustomSoupItem.EnderBowl(new Item.Properties().stacksTo(1).tab(VSFoodstuffsTab.TAB).food(VSFoods.WATER_BOWL)));
    public static final RegistryObject<Item> oak_lava_stew = ITEMS.register("oak_lava_stew", () -> new CustomSoupItem.OakBowl(new Item.Properties().stacksTo(1).tab(VSFoodstuffsTab.TAB).food(VSFoods.LAVA_BOWL)));
    public static final RegistryObject<Item> spruce_lava_stew = ITEMS.register("spruce_lava_stew", () -> new CustomSoupItem.SpruceBowl(new Item.Properties().stacksTo(1).tab(VSFoodstuffsTab.TAB).food(VSFoods.LAVA_BOWL)));
    public static final RegistryObject<Item> birch_lava_stew = ITEMS.register("birch_lava_stew", () -> new CustomSoupItem.BirchBowl(new Item.Properties().stacksTo(1).tab(VSFoodstuffsTab.TAB).food(VSFoods.LAVA_BOWL)));
    public static final RegistryObject<Item> jungle_lava_stew = ITEMS.register("jungle_lava_stew", () -> new CustomSoupItem.JungleBowl(new Item.Properties().stacksTo(1).tab(VSFoodstuffsTab.TAB).food(VSFoods.LAVA_BOWL)));
    public static final RegistryObject<Item> acacia_lava_stew = ITEMS.register("acacia_lava_stew", () -> new CustomSoupItem.AcaciaBowl(new Item.Properties().stacksTo(1).tab(VSFoodstuffsTab.TAB).food(VSFoods.LAVA_BOWL)));
    public static final RegistryObject<Item> dark_oak_lava_stew = ITEMS.register("dark_oak_lava_stew", () -> new CustomSoupItem.DarkOakBowl(new Item.Properties().stacksTo(1).tab(VSFoodstuffsTab.TAB).food(VSFoods.LAVA_BOWL)));
    public static final RegistryObject<Item> painting_lava_stew = ITEMS.register("painting_lava_stew", () -> new CustomSoupItem.PaintingBowl(new Item.Properties().stacksTo(1).tab(VSFoodstuffsTab.TAB).food(VSFoods.LAVA_BOWL)));
    public static final RegistryObject<Item> crimson_lava_stew = ITEMS.register("crimson_lava_stew", () -> new CustomSoupItem.CrimsonBowl(new Item.Properties().stacksTo(1).tab(VSFoodstuffsTab.TAB).food(VSFoods.LAVA_BOWL)));
    public static final RegistryObject<Item> warped_lava_stew = ITEMS.register("warped_lava_stew", () -> new CustomSoupItem.WarpedBowl(new Item.Properties().stacksTo(1).tab(VSFoodstuffsTab.TAB).food(VSFoods.LAVA_BOWL)));
    public static final RegistryObject<Item> ender_lava_stew = ITEMS.register("ender_lava_stew", () -> new CustomSoupItem.EnderBowl(new Item.Properties().stacksTo(1).tab(VSFoodstuffsTab.TAB).food(VSFoods.LAVA_BOWL)));
    public static final RegistryObject<Item> oak_milk_stew = ITEMS.register("oak_milk_stew", () -> new CustomSoupItem.OakBowl(new Item.Properties().stacksTo(1).tab(VSFoodstuffsTab.TAB).food(VSFoods.STANDARD_BOWL)));
    public static final RegistryObject<Item> spruce_milk_stew = ITEMS.register("spruce_milk_stew", () -> new CustomSoupItem.SpruceBowl(new Item.Properties().stacksTo(1).tab(VSFoodstuffsTab.TAB).food(VSFoods.STANDARD_BOWL)));
    public static final RegistryObject<Item> birch_milk_stew = ITEMS.register("birch_milk_stew", () -> new CustomSoupItem.BirchBowl(new Item.Properties().stacksTo(1).tab(VSFoodstuffsTab.TAB).food(VSFoods.STANDARD_BOWL)));
    public static final RegistryObject<Item> jungle_milk_stew = ITEMS.register("jungle_milk_stew", () -> new CustomSoupItem.JungleBowl(new Item.Properties().stacksTo(1).tab(VSFoodstuffsTab.TAB).food(VSFoods.STANDARD_BOWL)));
    public static final RegistryObject<Item> acacia_milk_stew = ITEMS.register("acacia_milk_stew", () -> new CustomSoupItem.AcaciaBowl(new Item.Properties().stacksTo(1).tab(VSFoodstuffsTab.TAB).food(VSFoods.STANDARD_BOWL)));
    public static final RegistryObject<Item> dark_oak_milk_stew = ITEMS.register("dark_oak_milk_stew", () -> new CustomSoupItem.DarkOakBowl(new Item.Properties().stacksTo(1).tab(VSFoodstuffsTab.TAB).food(VSFoods.STANDARD_BOWL)));
    public static final RegistryObject<Item> painting_milk_stew = ITEMS.register("painting_milk_stew", () -> new CustomSoupItem.PaintingBowl(new Item.Properties().stacksTo(1).tab(VSFoodstuffsTab.TAB).food(VSFoods.STANDARD_BOWL)));
    public static final RegistryObject<Item> crimson_milk_stew = ITEMS.register("crimson_milk_stew", () -> new CustomSoupItem.CrimsonBowl(new Item.Properties().stacksTo(1).tab(VSFoodstuffsTab.TAB).food(VSFoods.STANDARD_BOWL)));
    public static final RegistryObject<Item> warped_milk_stew = ITEMS.register("warped_milk_stew", () -> new CustomSoupItem.WarpedBowl(new Item.Properties().stacksTo(1).tab(VSFoodstuffsTab.TAB).food(VSFoods.STANDARD_BOWL)));
    public static final RegistryObject<Item> ender_milk_stew = ITEMS.register("ender_milk_stew", () -> new CustomSoupItem.EnderBowl(new Item.Properties().stacksTo(1).tab(VSFoodstuffsTab.TAB).food(VSFoods.STANDARD_BOWL)));
    public static final RegistryObject<Item> oak_powder_snow_stew = ITEMS.register("oak_powder_snow_stew", () -> new CustomSoupItem.OakBowl(new Item.Properties().stacksTo(1).tab(VSFoodstuffsTab.TAB).food(Foods.APPLE)));
    public static final RegistryObject<Item> spruce_powder_snow_stew = ITEMS.register("spruce_powder_snow_stew", () -> new CustomSoupItem.SpruceBowl(new Item.Properties().stacksTo(1).tab(VSFoodstuffsTab.TAB).food(Foods.APPLE)));
    public static final RegistryObject<Item> birch_powder_snow_stew = ITEMS.register("birch_powder_snow_stew", () -> new CustomSoupItem.BirchBowl(new Item.Properties().stacksTo(1).tab(VSFoodstuffsTab.TAB).food(Foods.APPLE)));
    public static final RegistryObject<Item> jungle_powder_snow_stew = ITEMS.register("jungle_powder_snow_stew", () -> new CustomSoupItem.JungleBowl(new Item.Properties().stacksTo(1).tab(VSFoodstuffsTab.TAB).food(Foods.APPLE)));
    public static final RegistryObject<Item> acacia_powder_snow_stew = ITEMS.register("acacia_powder_snow_stew", () -> new CustomSoupItem.AcaciaBowl(new Item.Properties().stacksTo(1).tab(VSFoodstuffsTab.TAB).food(Foods.APPLE)));
    public static final RegistryObject<Item> dark_oak_powder_snow_stew = ITEMS.register("dark_oak_powder_snow_stew", () -> new CustomSoupItem.DarkOakBowl(new Item.Properties().stacksTo(1).tab(VSFoodstuffsTab.TAB).food(Foods.APPLE)));
    public static final RegistryObject<Item> painting_powder_snow_stew = ITEMS.register("painting_powder_snow_stew", () -> new CustomSoupItem.PaintingBowl(new Item.Properties().stacksTo(1).tab(VSFoodstuffsTab.TAB).food(Foods.APPLE)));
    public static final RegistryObject<Item> crimson_powder_snow_stew = ITEMS.register("crimson_powder_snow_stew", () -> new CustomSoupItem.CrimsonBowl(new Item.Properties().stacksTo(1).tab(VSFoodstuffsTab.TAB).food(Foods.APPLE)));
    public static final RegistryObject<Item> warped_powder_snow_stew = ITEMS.register("warped_powder_snow_stew", () -> new CustomSoupItem.WarpedBowl(new Item.Properties().stacksTo(1).tab(VSFoodstuffsTab.TAB).food(Foods.APPLE)));
    public static final RegistryObject<Item> ender_powder_snow_stew = ITEMS.register("ender_powder_snow_stew", () -> new CustomSoupItem.EnderBowl(new Item.Properties().stacksTo(1).tab(VSFoodstuffsTab.TAB).food(Foods.APPLE)));
}
