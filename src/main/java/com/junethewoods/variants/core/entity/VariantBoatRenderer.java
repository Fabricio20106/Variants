...
public class VariantBoatRenderer extends EntityRenderer<VariantBoatEntity> {
    private static final ResourceLocation[] BOAT_TEXTURES = new ResourceLocation[] {
            Variants.resourceLoc("textures/entity/boat/painting.png"),
            Variants.resourceLoc("textures/entity/boat/crimson.png"),
            //Variants.resourceLoc("textures/entity/boat/warped.png")
    };
    protected final VariantBoatModel modelBoat = new VariantBoatModel();

    public VariantBoatRenderer(EntityRendererManager renderManagerIn) {
        super(renderManagerIn);
        this.shadowSize = 0.8F;
    }

    public void render(VariantBoatEntity entityIn, float entityYaw, float partialTicks, MatrixStack matrixStackIn, IRenderTypeBuffer bufferIn, int packedLightIn) {
        matrixStackIn.push();
     ...
     */
    public ResourceLocation getEntityTexture(VariantBoatEntity entity) {
