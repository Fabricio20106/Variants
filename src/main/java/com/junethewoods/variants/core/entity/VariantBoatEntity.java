package com.junethewoods.variants.core.entity;

import com.junethewoods.variants.core.init.BlockInit;
import com.junethewoods.variants.core.init.EntityInit;
...
public class VariantBoatEntity extends Entity {
    private static final DataParameter<Integer> TIME_SINCE_HIT = EntityDataManager.createKey(VariantBoatEntity.class, DataSerializers.VARINT);
    private static final DataParameter<Integer> FORWARD_DIRECTION = EntityDataManager.createKey(VariantBoatEntity.class, DataSerializers.VARINT);
    private static final DataParameter<Float> DAMAGE_TAKEN = EntityDataManager.createKey(VariantBoatEntity.class, DataSerializers.FLOAT);
    private static final DataParameter<Integer> BOAT_TYPE = EntityDataManager.createKey(VariantBoatEntity.class, DataSerializers.VARINT);
    private static final DataParameter<Boolean> LEFT_PADDLE = EntityDataManager.createKey(VariantBoatEntity.class, DataSerializers.BOOLEAN);
    private static final DataParameter<Boolean> RIGHT_PADDLE = EntityDataManager.createKey(VariantBoatEntity.class, DataSerializers.BOOLEAN);
    private static final DataParameter<Integer> ROCKING_TICKS = EntityDataManager.createKey(VariantBoatEntity.class, DataSerializers.VARINT);
    ...
    public VariantBoatEntity(EntityType<? extends VariantBoatEntity> entityType, World world) {
        super(entityType, world);
        this.preventEntitySpawning = true;
    }

    public VariantBoatEntity(World worldIn, double x, double y, double z) {
        this(EntityInit.variant_boat.get(), worldIn);
    ...
    public VariantBoatEntity(FMLPlayMessages.SpawnEntity spawnEntity, World world) {
    ...
    public Item getItemBoat() {
        switch (this.getBoatType()) {
            case painting:
            default:
                return StuffInit.painting_boat.get();
            case crimson:
                return StuffInit.crimson_boat.get();
            case warped:
                return StuffInit.warped_boat.get();
        }
    }
    ...
    protected void readAdditional(CompoundNBT compound) {
        if (compound.contains("Type", 8)) {
            this.setBoatType(VariantBoatEntity.Type.getTypeFromString(compound.getString("Type")));
        }
    ...
    public void setBoatType(VariantBoatEntity.Type boatType) {
        this.dataManager.set(BOAT_TYPE, boatType.ordinal());
    }

    public VariantBoatEntity.Type getBoatType() {
        return VariantBoatEntity.Type.byId(this.dataManager.get(BOAT_TYPE));
    }
    ...
    public enum Type {
        painting(BlockInit.painting_planks.get(), "painting"),
         ...
         */
        public static VariantBoatEntity.Type byId(int id) {
            VariantBoatEntity.Type[] types = values();
        ...
        public static VariantBoatEntity.Type getTypeFromString(String nameIn) {
            VariantBoatEntity.Type[] types = values();
