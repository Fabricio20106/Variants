package com.junethewoods.variants.core.worldgen.vegetation;
...
public class VSVegetationPlacements {
    ...
    public static final Holder<PlacedFeature> SUNNY_FLOWER_PATCH = PlacementUtils.register("variants:sunny_flower_patch", VSVegetationFeatures.SUNNY_FLOWER_PATCH,
            RarityFilter.onAverageOnceEvery(3), InSquarePlacement.spread(), PlacementUtils.HEIGHTMAP, CountPlacement.of(ClampedInt.of(UniformInt.of(-3, 1),
                    0, 1)), BiomeFilter.biome());
    /*public static final Holder<PlacedFeature> GLOW_BERRY_BUSH_PATCH = PlacementUtils.register("variants:glow_berry_bush_patch", VSVegetationFeatures.GLOW_BERRY_BUSH_PATCH,
            RarityFilter.onAverageOnceEvery(32), InSquarePlacement.spread(), PlacementUtils.RANGE_BOTTOM_TO_MAX_TERRAIN_HEIGHT,
            EnvironmentScanPlacement.scanningFor(Direction.DOWN, BlockPredicate.solid(), BlockPredicate.ONLY_IN_AIR_PREDICATE, 12, BiomeFilter.biome());*/
    ...
    public static void onBiomeLoad(final BiomeLoadingEvent event) {
        ...
        /*if (event.getName() != null && Objects.equals(Biomes.SUNFLOWER_PLAINS.getRegistryName(), event.getName())) {
            settings.addFeature(GenerationStep.Decoration.VEGETAL_DECORATION, SUNNY_FLOWER_PATCH);
        }*/
    }
}
