...
public class VSSoundTypes extends ForgeSoundType {
    public static final VSSoundTypes QUARTZ_LADDER = new VSSoundTypes(1.0F, 1.0F, () -> SoundEvents.LADDER_BREAK, () -> SoundEvents.LADDER_STEP, () -> SoundEvents.STONE_PLACE, () -> SoundEvents.STONE_HIT, () -> SoundEvents.LADDER_FALL);
