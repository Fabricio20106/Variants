...
public class DamageBehaviorSource extends DamageSource {
    ...
    public DamageBehaviorSource(CompoundNBT sourceTag, LivingEntity livEntity) {
        super(!sourceTag.contains("message_id", NBTUtils.STRING) || sourceTag.getString("message_id").isEmpty() ? "generic" : sourceTag.getString("message_id"));
        ...
        if (this.sourceTag.contains("scaling", NBTUtils.STRING)) {
    ...
    public float getFoodExhaustion() {
        return this.sourceTag.contains("food_exhaustion", NBTUtils.FLOAT) ? this.sourceTag.getFloat("food_exhaustion") : super.getFoodExhaustion();
    }
