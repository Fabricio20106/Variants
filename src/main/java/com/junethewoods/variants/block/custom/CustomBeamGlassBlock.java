...
public class CustomBeamGlassBlock extends AbstractGlassBlock implements IBeaconBeamColorProvider {
    ...
    public void appendHoverText(ItemStack stack, @Nullable IBlockReader world, List<ITextComponent> tooltip, ITooltipFlag flag) {
        ...
        if (flag.isAdvanced()) tooltip.add(new TranslationTextComponent("tooltip." + Variants.MOD_ID + ".glass_beam_color", new StringTextComponent(String.format("#%06X", this.beamColor)).withStyle(Style.EMPTY.withColor(Color.fromRgb(this.beamColor))))
