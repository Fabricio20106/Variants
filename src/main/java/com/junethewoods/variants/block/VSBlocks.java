...
public class VSBlocks {
    ...
    public static final RegistryObject<Block> ENDER_NYLIUM_QUARTZ_ORE = BLOCKS.register("ender_nylium_quartz_ore", () -> new VSOreBlock(2, 5, AbstractBlock.Properties.of(Material.STONE, MaterialColor.SAND).requiresCorrectToolForDrops().strength(3f, 9f)));
