...
public class VSBlocks {
    ...
    public static final RegistryObject<Block> AZURE_BLUET_LEAVES = BLOCKS.register("azure_bluet_leaves", () -> new LeavesBlock(AbstractBlock.Properties.copy(Blocks.OAK_LEAVES)));
    ...
    public static final RegistryObject<Block> MOSSY_END_STONE_BRICK_STAIRS = BLOCKS.register("mossy_end_stone_brick_stairs", () -> new StairsBlock(MOSSY_END_STONE_BRICKS.get().defaultBlockState(), AbstractBlock.Properties.copy(Blocks.END_STONE_BRICKS)));
    public static final RegistryObject<Block> MOSSY_END_STONE_BRICK_SLAB = BLOCKS.register("mossy_end_stone_brick_slab", () -> new SlabBlock(AbstractBlock.Properties.copy(Blocks.END_STONE_BRICKS)));
    public static final RegistryObject<Block> MOSSY_END_STONE_BRICK_WALL = BLOCKS.register("mossy_end_stone_brick_wall", () -> new WallBlock(AbstractBlock.Properties.copy(Blocks.END_STONE_BRICKS)));
    ...
    public static final RegistryObject<Block> MOSSY_PURPUR_BLOCK_STAIRS = BLOCKS.register("mossy_purpur_block_stairs", () -> new StairsBlock(MOSSY_PURPUR_BLOCK.get().defaultBlockState(), AbstractBlock.Properties.copy(Blocks.PURPUR_BLOCK)));
    public static final RegistryObject<Block> MOSSY_PURPUR_BLOCK_SLAB = BLOCKS.register("mossy_purpur_block_slab", () -> new SlabBlock(AbstractBlock.Properties.copy(Blocks.PURPUR_BLOCK)));
    public static final RegistryObject<Block> MOSSY_PURPUR_BLOCK_WALL = BLOCKS.register("mossy_purpur_block_wall", () -> new WallBlock(AbstractBlock.Properties.copy(Blocks.PURPUR_BLOCK)));
    ...
    public static final RegistryObject<Block> MOSSY_NETHER_BRICK_STAIRS = BLOCKS.register("mossy_nether_brick_stairs", () -> new StairsBlock(MOSSY_NETHER_BRICKS.get().defaultBlockState(), AbstractBlock.Properties.copy(Blocks.NETHER_BRICKS)));
    public static final RegistryObject<Block> MOSSY_NETHER_BRICK_SLAB = BLOCKS.register("mossy_nether_brick_slab", () -> new SlabBlock(AbstractBlock.Properties.copy(Blocks.NETHER_BRICKS)));
    public static final RegistryObject<Block> MOSSY_NETHER_BRICK_WALL = BLOCKS.register("mossy_nether_brick_wall", () -> new WallBlock(AbstractBlock.Properties.copy(Blocks.NETHER_BRICKS)));
    ...
    public static final RegistryObject<Block> ENDER_NYLIUM_QUARTZ_ORE = BLOCKS.register("ender_nylium_quartz_ore", () -> new VSOreBlock(2, 5, AbstractBlock.Properties.of(Material.STONE, MaterialColor.COLOR_PURPLE).requiresCorrectToolForDrops().strength(3, 9)));
    ...
    public static final RegistryObject<Block> SOUL_BREWING_STAND = BLOCKS.register("soul_brewing_stand", () -> new SoulBrewingStandBlock(AbstractBlock.Properties.copy(Blocks.BREWING_STAND)));
    ...
    public static final RegistryObject<Block> SUNNY_FLOWER = BLOCKS.register("sunny_flower", () -> new SunnyFlowerBlock(Effects.INVISIBILITY, 9, AbstractBlock.Properties.of(Material.PLANT).noCollission().instabreak().sound(SoundType.CROP)));
